...
$(function() {
    ...
    $(document).ready(function() {
        ...
        if (document.querySelector("#apex-timeline-chart")) {
        ...
        if (document.querySelector("#one_month")) {
    ...
    $(document).ready(function() {
        ...
        if (document.querySelector("#apex-circle-gradient")) {
            var chart = new ApexCharts(
    ...
    $(document).ready(function() {
        ...
        if (document.querySelector("#apexspark1")) {
        ...
        if (document.querySelector("#apexspark2")) {
        ...
        if (document.querySelector("#apexspark3")) {
        ...
        if (document.querySelector("#apexspark4")) {
